...
class ChannelTypeDAO(BaseDAO[ChannelTypeModel]):
    ...
    async def get_first(self, *args, **kwargs) -> ChannelTypeModel | None:
    ...
    async def create(self, obj: ChannelTypeModel) -> ChannelTypeModel | None:
        return await super().create(obj)

    async def get_or_create(self, **kwargs) -> tuple[ChannelTypeModel, bool]:
        return await super().get_or_create(**kwargs)

    async def update(self, obj: ChannelTypeModel) -> ChannelTypeModel | None:
